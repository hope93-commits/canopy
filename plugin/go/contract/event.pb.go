...
type EventCustom struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// msg: custom payload.
	Msg           *any1.Any `protobuf:"bytes,1,opt,name=msg,proto3" json:"msg,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *EventCustom) GetMsg() *any1.Any {
	if x != nil {
		return x.Msg
	}
	return nil
...
const file_event_proto_rawDesc = "" +
	...
	"\x03msg\"5\n" +
	"\vEventCustom\x12&\n" +
	"\x03msg\x18\x01 \x01(\v2\x14.google.protobuf.AnyR\x03msgB5Z3github.com/hope93-commits/canopy/plugin/go/contractb\x06proto3"
